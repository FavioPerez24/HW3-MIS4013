...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editTeamModal<?php echo $team['TID']; ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
            <div class="mb-3">
            <label for="Tname<?php echo $team['TID']; ?>" class="form-label">Team Name</label>
<?php
