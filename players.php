...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertPlayer($_POST['$PName'], $_POST['$PDOB'], $_POST['$PNationality'], $_POST['$PPosition'], $_POST['$TID'])) {
      ...
      break;
    case "Edit":
      if (updatePlayer($_POST['$PName'], $_POST['$PDOB'], $_POST['$PNationality'], $_POST['$PPosition'], $_POST['$TID'], $_POST['PID'])) {
...
Include "view/players/page1.php";
