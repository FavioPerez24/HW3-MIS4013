...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editEnrollmentModal<?php echo $major['Enrollment_ID']; ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editEnrollmentModalLabel<?php echo $major['Enrollment_ID']; ?>">Edit enrollment</h1>
