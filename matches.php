...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertMatches($_POST['MDetails'],$_POST['MDate'], $_POST['MConditions'])) {
      ...
      break;
    case "Edit":
      if (updateMatches($_POST['MDetails'], $_POST['MDate'], $_POST['MConditions'], $_POST['MID'])) {
