...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editChoiceModal<?php echo $major['program_code']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editChoiceModal<?php echo $major['program_code']; ?>" tabindex="-1" aria-labelledby="editChoiceModalLabel<?php echo $major['program_code']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editChoiceModalLabel<?php echo $major['program_code']; ?>">Edit major</h1>
