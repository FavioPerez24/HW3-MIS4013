...
<h1>Student's Major</h1>
  ...
  <div class="col-auto">
<?php
include "view-studentbymajor-newform.php";
?>
  </div>
</div>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php include "view-studentbymajor-editform.php"; ?></td>
        <td>
      <form method="post" action="">
        <input type="hidden" name="mid2" value="<?php echo $major['program_code']; ?>">
